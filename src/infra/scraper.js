...
async function doScrap() {
  try {
    ...
    await page.screenshot({ path: "./src/scrnsave/sample.png" });
    ...
    await page.screenshot({ path: "./src/scrnsave/sample2.png" });
    ...
    await page.screenshot({ path: "./src/scrnsave/sample3.png" });
